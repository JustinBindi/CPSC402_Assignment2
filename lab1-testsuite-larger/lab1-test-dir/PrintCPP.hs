...
instance Print AbsCPP.Stm where
  prt i e = case e of
    ...
    AbsCPP.STypDef type_ -> prPrec i 0 (concatD [doc (showString "typedef"), prt 0 type_])
...
instance Print AbsCPP.QConst where
  prt i e = case e of
    AbsCPP.QDef elmts -> prPrec i 0 (concatD [prt 0 elmts])
...
instance Print AbsCPP.Exp where
  prt i e = case e of
    ...
    AbsCPP.ECondit exp1 exp2 exp3 -> prPrec i 2 (concatD [prt 2 exp1, doc (showString "?"), prt 3 exp2, doc (showString ":"), prt 3 exp3])
    AbsCPP.EPlusEq exp1 exp2 -> prPrec i 2 (concatD [prt 2 exp1, doc (showString "+="), prt 3 exp2])
    AbsCPP.EMinEq exp1 exp2 -> prPrec i 2 (concatD [prt 2 exp1, doc (showString "-="), prt 3 exp2])
    ...
    AbsCPP.ELShift exp exps -> prPrec i 10 (concatD [prt 10 exp, doc (showString "<<"), prt 11 exps])
    ...
    AbsCPP.ENegBool exp -> prPrec i 13 (concatD [doc (showString "!"), prt 14 exp])
    ...
    AbsCPP.EPointer exp -> prPrec i 14 (concatD [doc (showString "*"), prt 15 exp])
    AbsCPP.EPostDecr exp -> prPrec i 14 (concatD [prt 15 exp, doc (showString "--")])
    AbsCPP.EPostIncr exp -> prPrec i 14 (concatD [prt 15 exp, doc (showString "++")])
    ...
    AbsCPP.ECall exp exps -> prPrec i 15 (concatD [prt 16 exp, doc (showString "("), prt 3 exps, doc (showString ")")])
    ...
    AbsCPP.EInteger n -> prPrec i 16 (concatD [prt 0 n])
